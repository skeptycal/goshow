...
![GitHub Workflow Status](https://img.shields.io/github/workflow/status/skeptycal/goshow/Go) ![Codecov](https://img.shields.io/codecov/c/github/skeptycal/goshow)
...
```sh
gh repo create -y --public --template "https://github.com/skeptycal/goshow"
```
...
go get github.com/xxxxxx/goshow

cd ${GOPATH}/src/github.com/xxxxxx/goshow
...
> This is a copy of the example script available in the `cmd/example/goshow` folder:

```go
package main

import "github.com/skeptycal/goshow"
...
[issues]: (https://github.com/skeptycal/goshow/issues)
[pr]: (https://github.com/skeptycal/goshow/pulls)
